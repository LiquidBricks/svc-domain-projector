...
import { validatePayload } from '../../../../../../core/domain/edge/has_data_state/started/validatePayload.js'
...
test('validatePayload rejects a missing data stateEdgeId', () => {
  const handlerDiagnostics = makeDiagnosticsInstance()
...
test('validatePayload rejects a missing data started updatedAt', () => {
  const handlerDiagnostics = makeDiagnosticsInstance()
